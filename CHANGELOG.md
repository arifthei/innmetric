...
- About founder cards now show processed 640×800 portraits (`tunahan`/`mert` WebP 28–39 KB, JPEG 55–65 KB) above the name. `alt` is name, Co-founder and role. `object-position: center 18%`. Portraits are inset at 200×250, not full-bleed. Cards stay equal at 1920 and stack at 390. No faces on the homepage. The 2 MB source PNGs stay gitignored.
